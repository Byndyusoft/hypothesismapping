...
**Цели и KPI** – это точный аналог целей и метрик в Карте гипотез, но без балансирующих метрик, их нужно будет добавлять. Так как в BSC используются четыре перспективы, для их отображения понадобятся [топологии](topology.md) — [Многоцелевая карта](topology.md#manygoals) и [Группировка элементов](topology.md#elementgroups), вместе или по отдельности.
...
_В работе разделы про СМД, продуктовый подход, Customer value proposition, ТРИЗ, Теорию ограничений, бизнес-канвасы, коучинг._
