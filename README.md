...
1. Глубокий анализ бизнес-процессов, который включает такие инструменты:
      ...
      2. [Карта реализации историй]([https://ashapiro.ru/articles/usm](https://ashapiro.ru/articles/sim)) 一 метод анализа-синтеза требований к продукту, усиленный инструментами предварительного проектирования.
      3. [Event Storming](https://ashapiro.ru/talks/tpost/hfphhlof91-event-storming-udachnoe-popolnenie-v-ars) 一 метод, представляющий собой практику мозгового штурма для формирования модели предметной области.
