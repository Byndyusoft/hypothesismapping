...
## Преимущества метода
1. Метод дает инструкцию, которая в разы упрощает «сборку» стратегии. Это делает стратегирование [доступным для многих](https://habr.com/ru/articles/844604/), а раньше было недостижимым из-за высокой когнитивной нагрузки при создании стратегии с «чистого листа».
