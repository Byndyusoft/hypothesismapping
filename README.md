...
- **Если** – принцип воздействия (без детализации), который приводит к измениню поведения субъекта.
...
1. [Связанный SWOT-анализ]([https://ru.wikipedia.org/wiki/SWOT-анализ](https://vc.ru/links/1923685-svyazannyy-swot-analiz-novyy-podkhod)) 一 это новый вариант известного SWOT-анализа.
