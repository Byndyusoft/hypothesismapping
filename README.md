...
Если вы пишите статью или делаете презентацию о Карте гипотез, то используйте готовые элементы фирменного стиля: бейджи, сертификаты, логотип.

Скачать архив со всеми элементами можно по ссылке: https://disk.yandex.ru/d/waAKXMZEWpkw5A
