...
3. Балансирующие метрики – параметры и их числовые значения, которые покажут нам, что мы не сделали хуже, чем было до начала работы по стратегии.<br>_Например, стоимость привлечения клиента не превышает ₽1000._
