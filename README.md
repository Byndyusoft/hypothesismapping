...
> Карта гипотез – это не брейншторм, не метод аналитики и не способ найти креативные решения.<br/>
> Карта гипотез – это визуализация ваших знаний в виде специальной схемы. На ней нужно описать экспертное мнение о том, как устроена механика воздействия на цель.<br/>
> Если этих знаний ещё нет или их недостаточно, то нужно вернуться на шаг назад и провести аналитику.
