...
- **Если** – принцип воздействия на субъект без детализации.
...
1. **Заказчик (владелец бюджета, лицо принимающее решение).** Оценивает целесообразность всей затеи, понимает идеи, в которые он будет инвестировать, подтверждает цели, сопоставляет эти цели с общей стратегией компании. Если берет карту в работу, то считается Владельцем карты.
