...
С целями связана топология, где [метрики выносятся на отдельный уровень](topology.md#2-метрики-цели-на-отдельном-уровне).

Типовые ошибки, которые допускают при описании гипотезы:
