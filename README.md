...
1. **Фасилитатор (ведущий).** Т.к. процесс создания Карты гипотез является не строго регламентированным, то для создания Карты ведущему понадобятся хорошие навыки организации и ведения подобных сессий.
