...
## Преимущества метода
1. Метод дает инструкцию, которая в разы упрощается «сборку» стратегии. Это делает стратегирование доступным для многих, а раньше было недостижимым из-за высокой когнитивной нагрузки при создании стратегии с «чистого листа».
