...
Заметки нужны, чтобы не упустить детали ситуации, обсуждаемой на стратсессии. Обычно заметки делает Фасилитатор Карты гипотез по ходу работы со стратегией. В заметки записывается всё, что может пригодится для создания стратегии. Определенного формата нет: заметка может содержать любой текст, изображения или схемы.
...
1. **Фасилитатор-технолог.** Т.к. процесс создания Карты гипотез является не строго регламентированным, то для создания Карты ведущему понадобятся хорошие навыки организации и ведения подобных сессий. Фасилитатор в обязательном порядке является методистом.
1. **Технолог.** Участник, который знает теорию Карта гипотез не ниже Практика 2 ступени.
...
С помощью ИИ-агента можно создавать, проверять и обновлять Карту гипотез, а также [оценивать зрелость стратегирования](maturitymodel.md#ai-agent). Для того, чтобы ИИ-агент придерживался стандарта используйте готовые скиллы [из этого проекта](https://github.com/Byndyusoft/sociotech-ai-skills).
