...
Карта гипотез – метод стратегического планирования. Ключевая часть метода – это уникальная нотация записи стратегии, которая подходит для проектирования следующего шага развития в любой деятельности.
