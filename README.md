...
С помощью ИИ-агента можно создавать, проверять и обновлять Карту гипотез. Для того, чтобы ИИ-агент придерживался стандарта используйте готовые скиллы [из этого проекта](https://github.com/Byndyusoft/sociotech-ai-skills).
