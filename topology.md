...
1. Задачи:
   ...
   * [Доска с задачами](#tasksboard)
1. [Многоуровневая карта](#manylevels)
1. [Тэги вместо стрелок](#directconnection)
...
Недостатки:
 * Сложность одновременной приоритизации всех элементов, потому что они могут по-разному влияеть на цель
