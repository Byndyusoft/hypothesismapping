...
1. [Метрики цели на отдельном уровне](#separatedmetrics)
1. [Соединение целей и гипотез вместо целей и субъектов](#directconnection)
1. [Разбивка задач по направлениям](#grouptasks)
1. [Группировка элементов](#elementgroups)
1. [Мотивация субъекта на отдельном уровне](#separatedmotivation)
1. [Многоуровневая карта](#manylevels)
1. [Иерархия целей](#goalshierarchy)
1. [Многоцелевая карта](#manygoals)

## 1. <a id="classic"></a> Классическая
...
## 2. <a id="separatedmetrics"></a> Метрики цели на отдельном уровне
...
## 3. <a id="directconnection"></a> Соединение целей и гипотез вместо целей и субъектов
...
## 4. <a id="grouptasks"></a> Разбивка задач по направлениям
...
## 5. <a id="elementgroups"></a> Группировка элементов
...
## 6. <a id="separatedmotivation"></a> Мотивация субъекта на отдельном уровне
...
## 7. <a id="manylevels"></a> Многоуровневая карта
...
## 8. <a id="goalshierarchy"></a> Иерархия целей
...
## 9. <a id="manygoals"></a> Многоцелевая карта
...
Недостатки:
 * Сложность одновременной приоритизации
